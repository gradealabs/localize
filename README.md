...
A simple localization libarary.

# Install

```
npm install gradealabs/localize --save
```
...
```js
// localize/index.js
import { StaticLocalize } from '@gradealabs/localize'
...
const localize = new StaticLocalize({ nativeLocale: 'en', locales })
moment.locale('en')
...
export function lc (key, context = {}) {
  return localize.lc(key, context)
}
```
